...
// only run git when TRUST_UI_VERSION is NOT provided
const gitCommit =
  process.env.TRUST_UI_VERSION ||
...
const defaultConfigs = [
  ...
  { name: 'UI_USE_MOCK_DATA', default: '', scope: 'global' },
  { name: 'DEPLOYMENT_MODE', default: 'standalone', scope: 'global' },
  {
    name: 'APPLICATION_NAME',
    default: 'Trustification Console',
    scope: 'global',
  },
  ...
  { name: 'UI_PORT', default: 3000, scope: 'webpack' },
